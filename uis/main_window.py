...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionIcon_size = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("./icons/size.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIcon_size.setIcon(icon6)
        self.actionIcon_size.setObjectName("actionIcon_size")
        self.menuFile.addAction(self.actionOpen_file)
        self.menuFile.addAction(self.actionSave_file)
        self.menuFile.addAction(self.actionIcon_size)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionIcon_size.setText(_translate("MainWindow", "Icon size"))
